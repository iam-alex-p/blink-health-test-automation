Feature: Blink Health Login
  ...
  Scenario: Blink Health Website Signing In Verification
    ...
    Then Verify Blink Health Sign In workflow with the following Credentials
      ...
      | aleksei.pokolev@rambler.ru   | tH~7@*+J9YiVR      | true         | true            | false             | Non-registered, but valid Email, Valid Password   |
      ...
      | aleksei.pokolev@mail.ru      | [blank]            | true         | false           | false             | Non-Registered Email, Blank Password              |
  ...
  Scenario: Blink Health Website Signing Up Verification
    ...
    Then Verify Blink Health Sign Up workflow with the following Credentials
      ...
      | friendshipistmagic@gmail.com | 12qA^            | true         | false           | Registered Email, Invalid Password |
      | friendshipistmagic@gmail.com | 12qaQA^          | true         | false           | Registered Email, Invalid Password |
      | friendshipistmagic@gmail.com | 12345QA^$        | true         | false           | Registered Email, Invalid Password |
      | friendshipistmagic@gmail.com | 12345qa^$        | true         | false           | Registered Email, Invalid Password |
      | friendshipistmagic@gmail.com | QA*(qa^$-+       | true         | false           | Registered Email, Invalid Password |
      | friendshipistmagic@gmail.com | 12345678qaQA     | true         | false           | Registered Email, Invalid Password |